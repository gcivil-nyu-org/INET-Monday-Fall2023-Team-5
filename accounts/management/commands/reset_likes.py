...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if dbname:
            ...
            # For example, using Django's database routers or manually selecting the database
            # using `using(dbname)` queryset method if your app handles multiple databases.
