...
class CleanupVersionsController(AbstractBaseController):
    class Meta:
        ...
        arguments = AbstractBaseController.Meta.arguments + [
            ...
            (
                ["--force"],
                dict(action="store_true", help="don't prompt for confirmation"),
            ),
        ]
    ...
    def do_command(self):
        ...
        app_versions = [
            ...
            if utils.get_delta_from_now_and_datetime(v["DateUpdated"]).days > older_than
        ]
        ...
        for version in app_versions:
            ...
            try:
                ...
                io.log_warning(
                    "Error deleting version {0}. Error: {1}".format(label, e.message)
                )
