...
class EBPBaseController(base.EbBaseController):
    class Meta:
        label = "base"
        arguments = [
            (["--version"], dict(action="store_true", help=flag_text["base.version"])),
        ]
...
class EBP(foundation.CementApp):
    ...
    def setup(self):
        ...
        self.add_arg(
            "-v", "--verbose", action="store_true", help=flag_text["base.verbose"]
        )
        ...
        self.add_arg(
            "--no-verify-ssl", action="store_true", help=flag_text["base.noverify"]
        )
        self.add_arg(
