...
def prompt_for_environment_name(
    default_name="myEnv", prompt_text="Enter Environment Name"
):
    ...
    while True:
        ...
        if re.match(constraint_pattern, env_name.lower()):
            ...
            echo(
                "Environment name must be 4 to 40 characters in length. It "
...
def prompt_for_cname(default=None):
    while True:
        ...
        if re.match("^[a-z0-9][a-z0-9-]{2,61}[a-z0-9]$", cname.lower()):
            ...
            echo(
                "CNAME must be 4 to 63 characters in length. It can"
...
def get_boolean_response(text=None, default=True):
    if not isinstance(default, bool):
        raise TypeError(
            "get_boolean_response() named argument 'default' must "
    ...
    while response not in ("y", "n", "yes", "no"):
        echo(strings["prompt.invalid"], strings["prompt.yes-or-no"])
