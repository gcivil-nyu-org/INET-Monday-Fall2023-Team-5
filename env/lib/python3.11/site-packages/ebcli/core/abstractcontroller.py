...
class AbstractBaseController(controller.CementBaseController):
    ...
    class Meta:
        ...
        arguments = [
            (
                ["environment_name"],
                dict(
                    action="store", nargs="?", default=[], help=flag_text["general.env"]
                ),
            ),
        ]
        epilog = ""
    ...
    def validate_workspace(cls):
        ...
        if "--modules" in sys.argv:
            ...
            cls.__name__ == "PlatformListController"
            or cls.__name__ == "EBPListController"
        ):
            pass
    ...
    def get_env_name(self, cmd_example=None, noerror=False, varname="environment_name"):
        ...
        if not env_name:
            ...
            if not cmd_example:
                ...
                message = strings["branch.noenv"].replace("eb {cmd}", cmd_example)
