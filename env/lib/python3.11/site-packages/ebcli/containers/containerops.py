...
CONTAINERFILES_DIR_PATH = path.join(
    path.dirname(path.realpath(__file__)), CONTAINERFILES_DIRNAME
)
CONTAINER_CONFIG_PATH = path.join(CONTAINERFILES_DIR_PATH, CONTAINER_CONFIG_FILENAME)
...
def is_container(soln_stk, container_config):
    ...
    return is_preconfigured(soln_stk, container_config) or is_generic(
        soln_stk, container_config
    )
