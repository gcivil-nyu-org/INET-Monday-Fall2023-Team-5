...
def make_container(
    envvars_str=None, host_port=None, allow_insecure_ssl=False, pathconfig=PathConfig
):
    """
...
def make_multicontainer_fs_handler(pathconfig):
    ...
    return MultiContainerFSHandler(pathconfig=pathconfig, dockerrun=dockerrun_dict)
