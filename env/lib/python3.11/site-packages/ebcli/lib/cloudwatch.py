...
def get_all_stream_names(log_group_name, log_stream_name_prefix=None):
    ...
    return [
        log_stream.name
        for log_stream in LogStream.log_stream_objects_from_json(
            streams.get("logStreams", [])
        )
    ]
...
def describe_log_streams(
    limit=None, log_group_name=None, log_stream_name_prefix=None, next_token=None
):
    params = dict()
