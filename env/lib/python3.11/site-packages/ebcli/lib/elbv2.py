                ...
                instance_healths.append(
                    {
                        ...
                        "Description": description["TargetHealth"].get(
                            "Description", ""
                        ),
...
def get_target_groups_for_load_balancer(load_balancer_arn):
    try:
        return _make_api_call(
            "describe_target_groups", LoadBalancerArn=load_balancer_arn
        )["TargetGroups"]
    except ServiceError as e:
        raise NotFoundError(e)
...
def get_listeners_for_load_balancer(load_balancer_arn):
    return _make_api_call("describe_listeners", LoadBalancerArn=load_balancer_arn)


def describe_load_balancers(load_balancer_name):
    return _make_api_call("describe_load_balancers", Names=load_balancer_name)
