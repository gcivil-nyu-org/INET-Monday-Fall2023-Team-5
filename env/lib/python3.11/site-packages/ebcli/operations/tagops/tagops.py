...
def raise_validation_error(problematic_key_set, problem_message, exception_class):
    """
    ...
    tags_error_message = (
        "{problem_message}{linesep}{linesep}  {stringified_keys}{linesep}".format(
...
class TagOps(object):
    ...
    def retrieve_taglist(self):
        if self.taglist is None:
            self.taglist = TagList(
                elasticbeanstalk.list_tags_for_resource(self.resource_arn)
            )
    ...
    def __communicate_changes_to_stdout(self):
        ...
        additions = [
            addition
            for addition in self.taglist.additions
