...
class LocalState(object):
    ...
    def dumps(self, path):
        fileoperations.write_to_data_file(
            data=cPickle.dumps(self, protocol=2), location=path
        )
...
def setenv(var_list, pathconfig=PathConfig):
    ...
    LocalState.save_envvarcollector(
        merged_env.filtered(), pathconfig.local_state_path()
    )
