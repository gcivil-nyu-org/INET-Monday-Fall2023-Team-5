...
# Special characters
UP_ARROW = "Up" if sys.platform.startswith("win") else "\u25b2"
DOWN_ARROW = "Dn" if sys.platform.startswith("win") else "\u25bc"
LEFT_ARROW = "Left" if sys.platform.startswith("win") else "\u25c4"
RIGHT_ARROW = "Right" if sys.platform.startswith("win") else "\u25ba"
