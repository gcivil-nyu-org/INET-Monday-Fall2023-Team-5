...
(application workspace only)""",
    ...
    "region.china.credentials": "To use the China (Beijing) region, account credentials unique to the "
    ...
    "logs.all_argument_and_zip_argument": 'You can\'t use the "--all" and "--zip" options together. '
    ...
    "logs.cloudwatch_log_source_argument_and_log_group_argument": 'You cannot use the "--cloudwatch-logs" and "--cloudwatch-log-source" '
    "options together.",
    "logs.cloudwatch_log_source_argumnent_is_invalid_for_retrieval": 'Invalid CloudWatch Logs source type for retrieving logs: "{}". '
    "Valid types: instance | environment-health",
    "logs.cloudwatch_log_source_argumnent_is_invalid_for_enabling_streaming": 'Invalid CloudWatch Logs source type for setting log streaming: "{}". Valid '
    "types: instance | environment-health | all",
    "logs.cloudwatch_logs_argument_and_log_group_argument": 'You can\'t use the "--log-group" option when setting log streaming. You can '
    "enable or disable all instance log group streaming and/or environment-health "
    "streaming.",
    "logs.cloudwatch_logs_argument_and_instance_argument": 'You can\'t use the "--instance" option when setting log streaming. You can '
    "enable or disable instance log streaming for the entire environment and/or "
    "environment-health streaming.",
    "logs.cloudwatch_logs_argument_and_all_argument": 'You can\'t use the "--all" option when setting log streaming. This is an '
    "output option for log retrieval commands.",
    "logs.cloudwatch_logs_argument_and_zip_argument": 'You can\'t use the "--zip" option when setting log streaming. This is an '
    "output option for log retrieval commands.",
    "logs.health_and_instance_argument": 'You can\'t use the "--instance" option when retrieving environment-health '
    "logs. The scope for these logs is the entire environment.",
    "logs.environment_health_log_streaming_disabled": "Can't retrieve environment-health logs for environment {}. "
    "Environment-health log streaming is disabled.",
    "logs.instance_log_streaming_disabled": "Can't retrieve instance logs for environment {}. Instance "
    "log streaming is disabled.",
    "logs.location": "Logs were saved to {location}",
    "logs.log_group_and_environment_health_log_source": 'You can\'t use the "--log-group" option when retrieving environment-health '
    "logs. These logs are in a specific, implied log group.",
    "beanstalk-logs.badinstance": "Can't find instance \"{}\" in the environment's instance logs on "
    "CloudWatch Logs.",
    ...
    "tags.duplicate_across_delete_and_update_lists": "A tag with the key '{0}' is specified for both '--delete' and '--update'. You can either "
...
prompts = {
    ...
    "upgrade.rollingupdate": "This operation replaces your instances with minimal or zero "
