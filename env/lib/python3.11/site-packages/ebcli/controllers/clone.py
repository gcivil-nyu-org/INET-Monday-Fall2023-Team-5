...
class CloneController(AbstractBaseController):
    class Meta(AbstractBaseController.Meta):
        ...
        arguments = [
            (
                ["environment_name"],
                dict(action="store", nargs="?", help=flag_text["clone.env"]),
            ),
            ...
            (
                ["-nh", "--nohang"],
                dict(action="store_true", help=flag_text["clone.nohang"]),
            ),
    ...
    def do_command(self):
        ...
        if not clone_name:
            ...
            clone_name = io.prompt_for_environment_name(
                default_name=unique_name, prompt_text="Enter name for Environment Clone"
            )
