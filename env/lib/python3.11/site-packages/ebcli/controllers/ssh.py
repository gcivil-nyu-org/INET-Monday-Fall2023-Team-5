...
class SSHController(AbstractBaseController):
    class Meta:
        ...
        arguments = AbstractBaseController.Meta.arguments + [
            ...
            (
                ["-o", "--keep_open"],
                dict(action="store_true", help=flag_text["ssh.keepopen"]),
            ),
            (["--force"], dict(action="store_true", help=flag_text["ssh.force"])),
            (["--setup"], dict(action="store_true", help=flag_text["ssh.setup"])),
