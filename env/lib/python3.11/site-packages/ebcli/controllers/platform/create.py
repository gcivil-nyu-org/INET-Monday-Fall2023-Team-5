    ...
    class Meta:
        ...
        arguments = [
            ...
            (
                ["-M", "--major-increment"],
                dict(
                    action="store_true", help=flag_text["platformcreateversion.major"]
                ),
            ),
            (
                ["-m", "--minor-increment"],
                dict(
                    action="store_true", help=flag_text["platformcreateversion.minor"]
                ),
            ),
            (
                ["-p", "--patch-increment"],
                dict(
                    action="store_true", help=flag_text["platformcreateversion.patch"]
                ),
            ),
            (["-i", "--instance-type"], dict(help=flag_text["create.itype"])),
            (
                ["-ip", "--instance_profile"],
                dict(action="store", help=flag_text["platformcreate.instanceprofile"]),
            ),
            (
                ["--vpc.id"],
                dict(dest="vpc_id", help=flag_text["platformcreateversion.vpc.id"]),
            ),
            (
                ["--vpc.subnets"],
                dict(
