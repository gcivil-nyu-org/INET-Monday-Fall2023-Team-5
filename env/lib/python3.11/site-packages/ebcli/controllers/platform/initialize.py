...
class GenericPlatformInitController(AbstractBaseController):
    class Meta:
        ...
        arguments = [
            (
                ["platform_name"],
                dict(help=flag_text["platforminit.name"], nargs="?", default=[]),
            ),
            (
                ["-i", "--interactive"],
    ...
    def do_command(self):
        ...
        self.interactive = (
            self.app.pargs.interactive or not self.app.pargs.platform_name
        )
        ...
        self.region = commonops.set_up_credentials(
            self.app.pargs.profile, self.region, self.interactive
        )
