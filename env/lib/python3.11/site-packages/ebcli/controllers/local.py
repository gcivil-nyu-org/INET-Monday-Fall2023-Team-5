...
class LocalController(AbstractBaseController):
    ...
    def _get_child_controllers():
        return [
            LocalLogsController,
            LocalOpenController,
            LocalPrintEnvController,
            LocalRunController,
            LocalSetEnvController,
...
class LocalRunController(AbstractBaseController):
    class Meta:
        ...
        arguments = [
            (["--envvars"], dict(help=flag_text["local.run.envvars"])),
            (["--port"], dict(type=int, help=flag_text["local.run.hostport"])),
            (
                ["--allow-insecure-ssl"],
        ...
        arguments = [
            (
                ...
                dict(
                    ...
                    nargs="+",
                    default=[],
                    help=flag_text["local.setenv.vars"],
                ),
            )
        ]
